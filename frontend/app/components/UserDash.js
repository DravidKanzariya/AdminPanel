        ...
        <Box sx={{ display: "flex", height: "100vh", backgroundColor: "#f5f5f5" }}>
            ...
            <Box sx={{ flexGrow: 1, p: 3, display: "flex", justifyContent: "center", alignItems: "center" }}>
                ...
                <Box sx={{ width: "100%" }}>
                    ...
                    {active !== "my-profile" &&
                        <Box>
                            <Typography variant="h4" className="capitalize">Welcome to User's Dashboard</Typography>
                            <Typography variant="h4" className="capitalize"> Hello {props.name} </Typography>
                        </Box>
                    }
